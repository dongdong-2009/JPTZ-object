...
int osd_print_Chinese(int start_x, int start_y, unsigned char* bufptr,unsigned char *charstr,int len)
{    
	int offset;
...
int osd_print_24(unsigned char* str, int len, int start_x, int start_y, unsigned char* bufptr,unsigned char *string)
{    
	int offset;
	int uuoffset,vvoffset;
	int uvstart = DISP_WIDTH*DISP_HEIGHT;
